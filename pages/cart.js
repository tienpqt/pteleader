                                                ...
                                                <tr>
                                                    ...
                                                    <td className="product-quantity">
                                                        <div className="input-counter">
                                                            <span className="minus-btn"><i className="fas fa-minus"></i></span>
                                                            <input type="text" min="1" defaultValue="1" />
                                                            <span className="plus-btn"><i className="fas fa-plus"></i></span>
                                                        </div>
                                                    </td>

                                                    <td className="product-subtotal">
                                                        <span className="subtotal-amount">$14.00</span>
                                                        <a href="#" className="remove"><i className="far fa-trash-alt"></i></a>
                                                    </td>
                                                </tr>
