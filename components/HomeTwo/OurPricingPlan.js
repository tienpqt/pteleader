    ...
    render() {
        return (
            <div className="pricing-area ptb-110 pt-0">
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-6">
                                        <div className="pricing-box active">
                                            ...
                                            <ul className="pricing-features">
                                                ...
                                                <li><i className='flaticon-tick'></i> Boot & Digital Assistants</li>
                                                <li><i className='flaticon-tick'></i> Customer Service</li>
                                                <li><i className='flaticon-tick'></i> Up to 3300 Subscribers</li>
                                                <li><i className='flaticon-tick'></i> Unlimited Broadcasts</li>
                                                <li><i className='flaticon-tick'></i> Landing Pages & Web Widgets</li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
                                        <div className="pricing-box">
                                            ...
                                            <ul className="pricing-features">
                                                ...
                                                <li><i className='flaticon-tick'></i> Boot & Digital Assistants</li>
                                                <li><i className='flaticon-tick'></i> Customer Service</li>
                                                <li><i className='flaticon-tick'></i> Up to 10000 Subscribers</li>
                                                <li><i className='flaticon-tick'></i> Unlimited Broadcasts</li>
                                                <li><i className='flaticon-tick'></i> Landing Pages & Web Widgets</li>
                                            </ul>
                                        </div>
                ...
                <div className="shape-img7"><img src="/images/shape/shape3.png" alt="image" /></div>
            </div>
        )
    }
}
