                            ...
                            <nav className="navbar navbar-expand-md navbar-light">
                                <Link href="/">
                                    <a className="navbar-brand">
                                        <img src="/images/pte-logo.png" className="main-logo" alt="logo" />
                                ...
                                <div className={classOne} id="navbarSupportedContent">
                                    <ul className="navbar-nav">
                                        ...
                                        <li className="nav-item">
                                            <Link href="/#">
                                                <a className="nav-link" onClick={e => e.preventDefault()}>
                                                    MOCK Test <i className="fas fa-chevron-down"></i>
                                                </a>
                                            </Link>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/#">
                                                <a className="nav-link" onClick={e => e.preventDefault()}>
                                                    Enrol Course <i className="fas fa-chevron-down"></i>
                                                </a>
                                            </Link>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/#">
                                                <a className="nav-link" onClick={e => e.preventDefault()}>
                                                    Our Blog <i className="fas fa-chevron-down"></i>
                                                </a>
                                            </Link>
